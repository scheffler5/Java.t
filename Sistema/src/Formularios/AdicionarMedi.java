 ...
 * @author gabri
 */
public class AdicionarMedi extends javax.swing.JFrame {

    /**
     * Creates new form AdicionarMedi
     */
    public AdicionarMedi() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdicionarMedi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdicionarMedi().setVisible(true);
            }
        });
    }
